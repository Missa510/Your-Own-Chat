        ...
        <header id="key_header" className="grid place-items-center h-[100dvh] font-[system-ui]">
            <section className="flex flex-col-reverse sm:flex-col xl:flex-row items-center justify-center gap-y-1 lg:gap-x-2">
                <div className="relative self-start lg:self-center">
                    ...
                    />
                    <span className="text-xs p-[5px] lg:text-xl absolute bg-red-500 top-0 right-0 lg:p-2 rounded-full"> +99 </span>
                </div>
                <div className="relative bg-slate-600 items-start justify-center flex-grow overflow-hidden px-6 py-5 flex flex-col gap-y-1 lg:gap-y-2 [containt: content] rounded-xl">
                    ...
                    <code className="text-slate-400"> By Missa510 | Enviado a <code>00:00</code></code>
                </div>
            </section>
        </header>
    )
